...
def evaluate_model(model,X_test:np.ndarray,y_test:np.ndarray):
    """Evaluate the model and log classification metrics and confusion metrix."""
    try:
...
def save_model_info(run_id:str,model_path:str,file_path:str)->None:
    ...
    try:
        # Create a directory with the info you want to save
        model_info={
            'run_id':run_id,
...
def main():
    ...
    with mlflow.start_run() as run:
        try:
            ...
            test_data=load_data(os.path.join(root_dir,'data/interim/test_precessed.csv'))
            ...
            save_model_info(run.info.run_id,model_path,'expreiment_info.json')

            #Log the vectorizer as an artifact
            report,cm=evaluate_model(model,X_test_tfidf,y_test)

            #Log classification report metrix for the test data
            ...
            logger.erro(f"Failed to complete model evaluation: {e}")
            print(f"Error: {e}")
