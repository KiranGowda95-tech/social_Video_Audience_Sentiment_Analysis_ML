...
def preprocess_comment(comment:str)->str:
    ...
    try:
        ...
        #Remove non-alphanumiric characters,except punctuation
...
def normalize_text(df:pd.DataFrame)->pd.DataFrame:
    ...
    try:
        ...
        logger.error(f"Error during trxt normalization: {e}")
        raise

def save_data(train_data: pd.DataFrame,test_data: pd.DataFrame,data_path: str)->None:
    """Save the precessed train and test datasets."""
    try:
        ...
        logger.debug(f"Precessed data saved to {interim_data_path}")
...
def main():
    try:
        ...
        #Preprocess the data
        train_precessed_data=normalize_text(train_data)
        test_processed_data=normalize_text(test_data)

        #Save the processed data
        save_data(train_precessed_data,
        test_processed_data,
        data_path="./data")
    except Exception as e:
